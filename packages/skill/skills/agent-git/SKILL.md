---
name: agent-git
description: 在 Git 仓库中修改代码时使用 Agent-Git checkpoint、状态查看、回滚和 squash 工作流。
---
...
Agent-Git 通过以下方式帮助 AI 编程助手安全管理 Git 历史：修改前创建临时 checkpoint，必要时查看仓库状态，失败时回滚，完成后把多个 checkpoint 和未提交变更压缩成一个整洁的正式提交。
