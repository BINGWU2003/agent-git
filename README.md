...
| `@agentgit/typescript-config` | Shared TypeScript and tsdown configuration for workspace packages. |
...
- `typescript-config` owns shared TypeScript-related configuration, including package build defaults.
